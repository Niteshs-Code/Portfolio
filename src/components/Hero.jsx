      ...
      <div className="max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative max-w-2xl mb-20 mt-28 px-6 lg:px-0">
          ...
          <p className="mt-6 text-gray-400 leading-relaxed text-base sm:text-lg">
            I am a Full Stack Web Developer and Digital Marketing Expert based in India. I specialize in building fast Next.js apps, robust MERN platforms, and custom Shopify/WordPress e-commerce stores—all backed by high-performance Google Ads strategies to scale your business.
          </p>
